...
const CLIENT_STATE_CLOSED = 0;
const CLIENT_STATE_CONNECTING = 1;
const CLIENT_STATE_CONNECTED = 2;

const QUEUE_ITEM_REQUEST = 0;
const QUEUE_ITEM_DONE = 1;
