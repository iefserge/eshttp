...
const isValidMethodCharCode = tokens.isValidMethodCharCode;
const isValidCharCode = tokens.isValidCharCode;

const PARSER_MAX_HEADERS_LENGTH = 1024 * 16; /* 16 KiB */
const PARSER_MAX_TRAILERS_LENGTH = 1024 * 1; /* 1 KiB */

const PARSER_STATE_METHOD = 0;
const PARSER_STATE_PATH = 1;
const PARSER_STATE_PROTOCOL = 2;
const PARSER_STATE_PROTOCOL_H = 3;
const PARSER_STATE_PROTOCOL_HT = 4;
const PARSER_STATE_PROTOCOL_HTT = 5;
const PARSER_STATE_PROTOCOL_HTTP = 6;
const PARSER_STATE_PROTOCOL_SLASH = 7;
const PARSER_STATE_VERSION_MAJOR = 8;
const PARSER_STATE_VERSION_DOT = 9;
const PARSER_STATE_VERSION_MINOR = 10;
const PARSER_STATE_CODE_1 = 11;
const PARSER_STATE_CODE_2 = 12;
const PARSER_STATE_CODE_3 = 13;
const PARSER_STATE_CODE_SPACE = 14;
const PARSER_STATE_PHRASE = 15;
const PARSER_STATE_HTTP_HEADERS = 16;
const PARSER_STATE_HTTP_HEADER_KEY = 17;
const PARSER_STATE_HTTP_HEADER_VALUE = 18;
const PARSER_STATE_BODY_CHUNK = 19;
const PARSER_STATE_BODY_CHUNK_SIZE = 20;
const PARSER_STATE_BODY_CHUNK_NEXT = 21;
const PARSER_STATE_DONE = 22;
const PARSER_STATE_ERROR = 23;
const PARSER_STATE_HTTP_TRAILERS = 24;
const PARSER_STATE_HTTP_TRAILER_KEY = 25;
const PARSER_STATE_HTTP_TRAILER_VALUE = 26;

const HTTP_CONNECTION_CLOSE = 0;
const HTTP_CONNECTION_KEEP_ALIVE = 1;
...
class HttpParser {
  ...
  chunk(u8, offset) {
    ...
    for (let i = offset, l = u8.length; i < l; ++i) {
