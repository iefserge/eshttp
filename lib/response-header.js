...
function makeHeader(code, headers, bodyLength, isChunked, isKeepAlive) {
  ...
  // append date header
  header += 'date: ' + String(date.getDateHeaderString()) + CRLF;
  ...
  for (let i = 0, l = headers._names.length; i < l; ++i) {
